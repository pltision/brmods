...
public class ConcreteRubbleBlock extends Block implements Farmland, MossableBlock {
    ...
    public double getWet(BlockState state, LevelReader level, BlockPos pos) {
        return Farmland.randomPlaneWet(0.7,level,pos);
    }
    ...
    public double nutrientFactor(BlockState state, @NotNull LevelReader level, BlockPos pos) {
        return 0.7* Farmland.biomeNutrientFactor(level,pos);
    }
